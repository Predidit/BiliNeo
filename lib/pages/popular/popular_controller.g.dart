...
mixin _$PopularController on _PopularController, Store {
  ...
  @override
  ObservableList<BangumiListItemModel> get bangumiList {
    _$bangumiListAtom.reportRead();
    return super.bangumiList;
  }

  @override
  set bangumiList(ObservableList<BangumiListItemModel> value) {
  ...
  @override
  Future<dynamic> queryBangumiListFeed({dynamic type = 'init'}) {
    return _$queryBangumiListFeedAsyncAction
        .run(() => super.queryBangumiListFeed(type: type));
  }
